...
MODEL_PATH = "../output/models/010/1_15_0.0572453.pt"
OUT_DIR = "../output/models/010/"
...
torch.onnx.export(model,                                                 # model being run
                  ...
                  os.path.join(OUT_DIR, "t1t2_fcn_hires.onnx"),                # where to save the model (can be a file or file-like object)
