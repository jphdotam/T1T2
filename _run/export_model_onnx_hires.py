...
MODEL_PATH = "../output/models/022/1_142_0.0012864.pt"
OUT_DIR = "../output/models/022/"
...
torch.onnx.export(model,                                                 # model being run
                  ...
                  os.path.join(OUT_DIR, "hrnet_pose.onnx"),                # where to save the model (can be a file or file-like object)
