...
from lib.vis import iou

PATH_AI = "./data/predictions_030"
...
mean_diff_plot(ai_t1, hx_t1, ax=axes[1], scatter_kwds={'alpha': 0.1})
...
# mean_diff_plot(ai_t2, hx_t2, ax=axes[1], scatter_kwds={'alpha': 0.1})
mean_diff_plot(add_jitter(ai_t2, 0.5), add_jitter(hx_t2, 0.5), ax=axes[1], scatter_kwds={'alpha': 0.05})
